...
class PermissionDetailsBottomSheet extends StatefulWidget {
  ...
  const PermissionDetailsBottomSheet({
    super.key,
...
class _PermissionDetailsBottomSheetState
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildCompactInfoRow(
                Icons.description,
                l.translate('permission_type'),
                widget.request.reasonAr ?? '',
              ),
  ...
  Future<void> _submitApproval(
    ...
    try {
      ...
      await widget.apiService.stage4_updateStatus(stage4Body, "exit");
      ...
      await widget.apiService.stage5_deleteStatus(stage5Body, "exit");
      ...
      if (trnsStatus == 0 || trnsStatus == -1) {
        ...
        log(stage6Body.toString(), name: "stage6body");
        await widget.apiService.stage6_postFinalStatus(stage6Body, "exit");
      } else {
