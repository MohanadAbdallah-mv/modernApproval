...
class _VacationDetailsBottomSheetState
  ...
  Future<void> _submitApproval(
    ...
    try {
      ...
      await widget.apiService.stage4_updateStatus(stage4Body, "lev_abs");
      ...
      await widget.apiService.stage5_deleteStatus(stage5Body, "lev_abs");
      ...
      if (trnsStatus == 0 || trnsStatus == -1) {
        ...
        await widget.apiService.stage6_postFinalStatus(stage6Body, "lev_abs");
      } else {
