...
class GeneralJournalDisbursementApprovalScreen extends StatefulWidget {
  final UserModel user;
  final int selectedPasswordNumber;

  const GeneralJournalDisbursementApprovalScreen({
    super.key,
    required this.user,
  ...
  @override
  State<GeneralJournalDisbursementApprovalScreen> createState() =>
      _GeneralJournalDisbursementApprovalScreenState();
}

class _GeneralJournalDisbursementApprovalScreenState
    extends State<GeneralJournalDisbursementApprovalScreen> {
  final ApiService _apiService = ApiService();
  late Future<List<GeneralJournalDesbursementApprovalItem>> _requestsFuture;

  String _storeNameFilter = '';
  DateTime? _selectedDate;
  List<GeneralJournalDesbursementApprovalItem> _filteredRequests = [];
  ...
  void _fetchData() {
    setState(() {
      _requestsFuture = _apiService.getGeneralJournalDisbursementApproval(
  ...
  // void _extractStoreNames(List<GeneralJournalDesbursementApprovalItem> requests) {
  //   final storeNames =
  //       requests
  //           .map((request) => request. ?? '')
  ...
  void _applyFilters(List<GeneralJournalDesbursementApprovalItem> allRequests) {
    setState(() {
      _filteredRequests =
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // List content
          Expanded(
            child: FutureBuilder<List<GeneralJournalDesbursementApprovalItem>>(
  ...
  Widget _buildSalesOrderCard(
    ...
    GeneralJournalDesbursementApprovalItem request,
    int index,
  ) {
        ...
        child: InkWell(
          onTap: () async {
            final result = await Navigator.push(
              ...
              MaterialPageRoute(
                builder:
                    (context) => GeneralJournalDisbursementDetailsScreen(
                      user: widget.user,
                      request: request,
                    ),
              ),
